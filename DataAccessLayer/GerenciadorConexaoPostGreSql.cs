...
{
    public class GerenciadorConexaoPostGreSql : GerenciadorConexao
    {
        ...
        /// <returns>Conexão ao banco de dados(PostGreSql)</returns>
        ...
        public override SqlConnection AbrirNovaConexao(string login, string senha, string banco)
        {
            ...
            if (banco != null) connectionString = "DSN=PostgreSQL;UID=postgres;PWD=**;";
        ...
        {
            string connectionString = null;
            connectionString = "DSN=PostgreSQL;UID=postgres;PWD=**;";
            //if (banco != null) connectionString = "Data Source=" + banco + ";";
            //connectionString += "User Id=" + login + ";Password=" + senha + ";";
            SqlConnection connection = new SqlConnection(connectionString);
            try
